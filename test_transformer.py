...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset-path', type=str, default='/home/xuyang/taming-transformers-master/data/HorseRiding/test_c01/',
                        help='Path to data.')
    parser.add_argument('--checkpoint-path', type=str,
                        default='/home/xuyang/taming-transformers-master/logs/HorseRiding_f16_continue_with_D2_32/checkpoints/last.ckpt',
    ...
    parser.add_argument('--reload', type=str,
                        default='/home/xuyang/VQGAN-pytorch/checkpoints_transformer/transformer_last_17.pt',
