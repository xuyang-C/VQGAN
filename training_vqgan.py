...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset-path', type=str, default='/home/xuyang/VQGAN-pytorch/data/UCF50/HorseRiding/train/', help='Path to data (default: /data)')
    ...
    parser.add_argument('--resume', type=str, default= 'vq-f8/model.ckpt', help='Restore model address.') # 'coco_oi_epoch12.ckpt' 'coco_epoch117.ckpt'
    parser.add_argument('--reload', type=str, default= None, help='Reload model from checkpoint') # '/home/xuyang/VQGAN-pytorch/checkpoints/vqgan_epoch_149.pt'
